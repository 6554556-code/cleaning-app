  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '10px' }}>
        <button onClick={prevMonth} style={{ background: 'none', border: 'none', fontSize: '18px', cursor: 'pointer', color: '#2481cc', padding: '0 6px' }}>‹</button>
        <span style={{ fontWeight: 'bold', fontSize: '14px' }}>{MONTHS[viewMonth]} {viewYear}</span>
        <button onClick={nextMonth} style={{ background: 'none', border: 'none', fontSize: '18px', cursor: 'pointer', color: '#2481cc', padding: '0 6px' }}>›</button>
      </div>
          ...
          return (
            <button
              ...
              style={{
                padding: '6px 2px',
                borderRadius: '8px',
                border: isSelected ? '2px solid #2481cc' : '2px solid transparent',
                background: isSelected ? '#2481cc' : isToday ? '#f0f7ff' : 'transparent',
                color: isSelected ? 'white' : isDisabled ? '#ccc' : isToday ? '#2481cc' : '#333',
                fontSize: '13px',
    ...
    <div ref={ref} style={{ position: 'relative', display: 'inline-block' }}>
      <button
        ...
        style={{
          ...
          background: value ? '#f0f7ff' : 'white',
          color: value ? '#2481cc' : '#666',
          fontSize: '14px',
          cursor: 'pointer',
