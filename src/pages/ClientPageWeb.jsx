...
// ─── ЛОГОТИП ────────────────────────────────────────────────────
// Положи файл в папку public/ и укажи путь (например '/logo.png').
// Если файл не найден или строка пустая — нарисуется встроенная иконка.
...
const BANNERS = [
    ...
    // ─── ПОДВАЛ: реквизиты и контакты ───────────────────────────────
// Правится только здесь. Любую строку можно оставить пустой ('') —
// она просто не отобразится.
const FOOTER = {
  company: 'ИП Иванова Ирина Владимировна',
  inn: '504017256555',
  ...
  socials: [
    { label: 'Telegram', href: 'https://t.me/ebookee_zabota' },
  ],
}
const Y = '#FDB813'
const YP = '#EBA800'
...
export default function ClientPageWeb({
  ...
  return (
    <div className="eb-web" style={{ background: '#FBFAF7', minHeight: '100vh', color: '#1A1A1A', colorScheme: 'light', textAlign: 'left' }}>
      ...
      {/* ─── ПОДВАЛ ─── */}
      <footer style={{ borderTop: '1px solid #ECECEC', background: '#fff', marginTop: 32 }}>
        <div style={{ maxWidth: 1560, margin: '0 auto', padding: '32px 24px' }}>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 40, justifyContent: 'space-between' }}>
            ...
            <div style={{ minWidth: 200 }}>
              ...
              <div style={{ fontSize: 14, lineHeight: 2 }}>
                {FOOTER.phone && <div><a href={`tel:${FOOTER.phone.replace(/[^+\d]/g, '')}`} style={{ color: '#3E3E3E', textDecoration: 'none' }}>{FOOTER.phone}</a></div>}
          ...
          <div style={{ borderTop: '1px solid #F0EDE6', marginTop: 26, paddingTop: 18, fontSize: 13, color: '#A0A0A0' }}>
